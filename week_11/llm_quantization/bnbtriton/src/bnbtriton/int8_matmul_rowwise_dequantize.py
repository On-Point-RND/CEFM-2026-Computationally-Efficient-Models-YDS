...
if not is_triton_available():
    ...
    def _int8_matmul_rowwise_dequantize(
        ...
        # In this case data for BLOCK_M and BLOCK_N can be stored in L2 cache

        #   width = GROUP_M * grid_n
        #   local_id = pid % width
        #   group_id = pid // width
        #   row_in_group = local_id % group_size
        #   pid_n = local_id // group_size
        #   pid_m = group_id * GROUP_M + row_in_group
